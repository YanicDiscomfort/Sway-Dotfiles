...
base=( dracut base-devel git neovim yazi bc zsh mesa amd-ucode unzip zip 7zip unrar-free btop bluez )
desktop=( wayland xorg-xwayland sway swaylock swaybg uwsm ly swaync waybar rofi-wayland rofi-emoji pipewire wireplumber pipewire-pulse pipewire-alsa pipewire-jack pipewire-audio xdg-desktop-portal-wlr papirus-icon-theme udiskie flameshot brightnessctl blueberry )
